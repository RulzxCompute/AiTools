...
export const resources: Resource[] = [
  ...
  },
  {
    id: 'agent-qa',
    name: 'Agent QA',
    description: 'Source-available CLI and MCP server for reusable web and mobile QA workflows; provider costs may apply',
    url: 'https://github.com/vostride/agent-qa',
    category: 'ai-tools',
    icon: 'Shield',
    tags: ['qa', 'testing', 'mcp', 'web', 'mobile'],
    docsUrl: 'https://vostride.com/docs/agent-qa',
    githubUrl: 'https://github.com/vostride/agent-qa',
    notes: 'Requires Node.js 24+. Current releases use FSL-1.1-ALv2 and convert to Apache-2.0 two years after publication.',
